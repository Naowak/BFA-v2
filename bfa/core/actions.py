...
from bfa.entities.agents import Agent, Target
from bfa.utils.utils import astar_pathfinding
import time
...
class ActionQueue:
    ...
    def update(self, dt, game_state):
        ...
        if self.current_action.is_complete:
            ...
            from bfa.utils.utils import compute_sight, compute_last_positions_seen
