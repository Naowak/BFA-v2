...
from bfa.entities.agents import Agent, Target, Obstacle, BonusMalus
from bfa.core.actions import ActionQueue
from bfa.utils.utils import compute_sight, compute_last_positions_seen, distance
import random
